...
import view.mainwindow2 as mwd
...
class Cocomo2Mainwindow(QMainWindow):
    ...
    def run(self):
        ...
        self.ui.total_label_2.setText(str(corrected_fp))
        self.ui.total_label_3.setText(str(loc))
    ...
    def __build(self):
        ...
        self.complexity_matrix_quantity = [
            [self.ui.simple_ei_spinBox, self.ui.med_ei_spinBox, self.ui.hard_ei_spinBox],
            [self.ui.simple_eo_spinBox, self.ui.med_eo_spinBox, self.ui.hard_eo_spinBox],
            [self.ui.simple_eq_spinBox, self.ui.med_eq_spinBox, self.ui.hard_eq_spinBox],
            [self.ui.simple_ilf_spinBox, self.ui.med_ilf_spinBox, self.ui.hard_ilf_spinBox],
            [self.ui.simple_eif_spinBox, self.ui.med_eif_spinBox, self.ui.hard_eif_spinBox]
        ]

        self.complexity_matrix_koef = [
            [self.ui.simple_ei_label, self.ui.med_ei_label, self.ui.hard_ei_label],
            [self.ui.simple_eo_label, self.ui.med_eo_label, self.ui.hard_eo_label],
            [self.ui.simple_eq_label, self.ui.med_eq_label, self.ui.hard_eq_label],
            [self.ui.simple_ilf_label, self.ui.med_ilf_label, self.ui.hard_ilf_label],
            [self.ui.simple_eif_label, self.ui.med_eif_label, self.ui.hard_eif_label]
        ]
